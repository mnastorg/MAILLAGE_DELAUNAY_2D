...
void basculement(int *TabTri,int *Tabarete,double *TabPt,FILE* mesh_init,FILE* mesh_delaunay)
{
  ...
  //mesh_init=fopen("maillage_point.mesh","r");
  int nP = 0, nT = 0;
  nP = nbP(mesh_init);
...
FILE *mesh2=NULL;
mesh2= fopen("BoiteMesh_problem2.mesh","w+"); //option d'ecriture sur le fichier, il faut réecrire tous les points et triangles
...
FILE *mesh=NULL;
mesh= fopen("BoiteMesh_modifie2.mesh","w+"); //option d'ecriture sur le fichier, il faut réecrire tous les points et triangles
